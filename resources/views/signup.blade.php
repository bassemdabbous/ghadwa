...
<head>
  <meta charset="UTF-8">
  <title>Register to Ghadwa</title>
...
<div class="login-form">
    <form action="{{ route('signup.action') }}" method="POST">
        @csrf
    <h1 class="display-5 text-black mb-3 visit">Register To Ghadwa</h1>    <div class="content">
    <div class="content">
    <div class="input-field">
        <input type="text" placeholder="Name" id="Name" name="name" autocomplete="nope">
      </div>
      <div class="input-field">
    ...
    <div class="action">
        <button style="background-color:#FEA116;color:white" type="submit">Sign up</button>
    </div>
  </form>
</div>
<!-- partial -->
